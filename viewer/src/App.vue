  ...
  <div class="container mx-auto p-4 h-screen">
    ...
    <header class="mb-4 bg-gray-300 py-6 border border-gray-400 rounded-md">
      <div class="mt-4 flex items-center">
        ...
        <input v-model="searchQuery" type="text" placeholder="Escriba el contenido a buscar" @keyup.enter="searchPage" class="p-2 border border-gray-400 rounded-md text-lg w-full mx-4">
